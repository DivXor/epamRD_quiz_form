...
public class PublishQuizDTO {
    ...
    private List<PublishAnswerDTO> answerForms = new ArrayList<>();
    ...
    public List<PublishAnswerDTO> getAnswerForms() {
        return answerForms;
    }

    public void setAnswerForms(List<PublishAnswerDTO> answerForms) {
